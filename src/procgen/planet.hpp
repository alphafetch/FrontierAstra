...
entt::entity createPlanet(Mesh mesh, entt::registry& reg, ResourceManager<GLuint>& textureManager, ResourceManager<GLuint>& shaderManager, std::string texturePath, std::string shaderKey, glm::vec3 position);
